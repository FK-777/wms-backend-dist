...
let FamilyService = class FamilyService {
    ...
    findAll(where = {}) {
        return this.familyModel.find(where).exec();
    }
    findOne(id) {
    ...
    update(id, updateFamilyDto) {
        return this.familyModel.updateOne({ _id: id }, updateFamilyDto).exec();
    }
};
FamilyService = __decorate([
    common_1.Injectable(),
    __param(0, mongoose_1.InjectModel(family_entity_1.Family.name)),
