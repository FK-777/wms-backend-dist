...
const get_hospital_dto_1 = require("./dto/get-hospital.dto");
...
let HospitalController = class HospitalController {
    ...
    create(createHospitalDto) {
        createHospitalDto.slug = util_service_1.UtilService.createSlug(createHospitalDto.name);
        return this.hospitalService.create(createHospitalDto);
    }
    findAll(getHospitalDto) {
        return this.hospitalService.findAll(getHospitalDto);
    }
    findOne({ id }) {
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [get_hospital_dto_1.GetHospitalDto]),
    __metadata("design:returntype", void 0)
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [dto_1.IdRequiredDto, update_hospital_dto_1.UpdateHospitalDto]),
    __metadata("design:returntype", void 0)
